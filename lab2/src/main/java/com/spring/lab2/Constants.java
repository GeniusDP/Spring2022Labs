...
public class Constants {
    public static class TodoController {
        ...
        public static final String SAVE_TODO_ITEM_SUMMARY = "create new lot";
        public static final String SAVE_TODO_ITEM_DESCRIPTION = "Save new lot using passed params";
